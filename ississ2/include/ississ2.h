...
public:
    ...
    virtual const char * local_GetModel();
    virtual int local_PrintResource(modelResource *res,char **p);
    virtual int local_TestResource(modelResource *res,char **p);
    virtual int local_Resource(char **args);
